...
> Antigravity OAuth requires your own Google OAuth credentials, supplied via `ANTI_API_ANTIGRAVITY_CLIENT_ID` and `ANTI_API_ANTIGRAVITY_CLIENT_SECRET`. They are no longer bundled in the source.
