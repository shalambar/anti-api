...
## Corpus Check
- 114 files · ~504,211 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1357 nodes · 2799 edges · 95 communities (86 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e416b77`
...
- `encodeSendUserCascadeMessage()` --calls--> `getAntigravityIdeVersion()`  [EXTRACTED]
  src/proto/encoder.ts → src/lib/antigravity-client.ts
...
Cohesion: 0.14
Nodes (26): getLegacyProjectDataDir(), getPublicGatewayToken(), start, remoteRouter, attemptNgrokReconnect(), clearSavedNgrokAuthtoken(), CONFIG_FILE, getAllTunnelStatus() (+18 more)
...
Cohesion: 0.16
Nodes (22): buildValidationReason(), extractReasoningEffort(), handleChatCompletion(), handleStreamCompletion(), normalizeChatPayload(), ReasoningEffort, buildStreamChunk(), generateChatId() (+14 more)

### Community 10 - "AccountManager"
Cohesion: 0.14
Nodes (3): AccountManager, getAccountLockWaitTimeoutMs(), getProjectID()

### Community 11 - "server.ts"
Cohesion: 0.16
Nodes (18): AVAILABLE_MODELS, DEFAULT_PORT, isLoopbackAddress(), isLoopbackHost(), isLoopbackOrigin(), isLoopbackRequest(), isRemoteControlPlaneAllowed(), LOOPBACK_IPV4 (+10 more)
...
Cohesion: 0.14
Nodes (23): base64Url(), buildCodexAuthorizeUrl(), CODEX_OAUTH_CONFIG, CODEX_PROXY_REFRESH_URL, CodexCallbackResult, CodexCliLoginSession, codexCliSessions, CodexOAuthProbe (+15 more)
...
Cohesion: 0.17
Nodes (15): ensurePrivateDir(), tightenPrivateFile(), writePrivateFile(), AUTH_DIR, ensureAccountCache(), ensureAuthDir(), loadAccountFromFile(), loadAccountsFromDisk() (+7 more)
...
Cohesion: 0.18
Nodes (20): AUTH_FILE, AuthData, initAuth(), LEGACY_AUTH_FILE, refreshToken(), saveAuth(), setAuth(), startOAuthLogin() (+12 more)
...
Cohesion: 0.13
Nodes (15): getPublicGatewayHost(), getPublicGatewayPort(), State, ANTIGRAVITY_DB_PATH, AntigravityAuthStatus, setupAntigravityToken(), addAccount, getLocalHost() (+7 more)
...
### Community 25 - "auth/types.ts"
Cohesion: 0.12
Nodes (12): AuthSource, ProviderAccount, ProviderAccountSummary, CopilotAuthSession, accountsByProvider, codexRemoteModels, codexSyncedWithAccountIds, Provider (+4 more)
...
### Community 30 - "quota-fetch.ts"
Cohesion: 0.18
Nodes (12): getAntigravityIdeVersion(), getAntigravityUserAgent(), ADJECTIVES, generateMockProjectId(), NOUNS, randomBase36(), randomChoice(), AntigravityModelInfo (+4 more)
...
Cohesion: 0.19
Nodes (10): AntigravityError, buildLogReason(), forwardError(), HTTPError, ParsedUpstreamError, parseUpstreamErrorBody(), summarizeUpstream429(), summarizeUpstreamError() (+2 more)
...
### Community 35 - "account-manager.ts"
Cohesion: 0.21
Nodes (12): applyRetryDelay(), calculateRetryDelay(), determineRetryStrategy(), parseDurationMs(), parseRetryAfterHeader(), parseRetryDelay(), parseRetryDelayFromText(), RetryStrategy (+4 more)
...
### Community 37 - "auth/route.ts"
Cohesion: 0.19
Nodes (14): authRouter, clearAuth(), getUserInfo(), isAuthenticated(), getCodexCliLoginStatus(), importCodexAuthSources(), CopilotDeviceCode, fetchCopilotAccount() (+6 more)

### Community 38 - "importCodexAuthFile"
Cohesion: 0.21
Nodes (16): buildExpiredIso(), decodeJwt(), deriveAccountIdFromFilename(), expandHomePath(), extractCodexTokenFields(), getJwtExpiresAt(), importCodexAuthFile(), importCodexProxyAuthFiles() (+8 more)
...
Cohesion: 0.26
Nodes (8): buildCascadeConfig(), DEFAULT_CASCADE_CONFIG, encodeSendUserCascadeMessage(), encodeVarint(), getModelEnumValue(), MODEL_ENUM, ProtoEncoder, SendMessageOptions
...
### Community 50 - "getProviderModels"
Cohesion: 0.20
Nodes (10): clearDynamicCodexModels(), clearDynamicCopilotModels(), clearDynamicKiroModels(), flattenDynamicModelsByAccount(), getProviderModels(), getProviderModelsForAccount(), mergeModelOptions(), setDynamicCodexModels() (+2 more)
...
### Community 60 - "refreshCodexAccessToken"
Cohesion: 0.31
Nodes (9): exchangeCodexCode(), fetchInsecureJson(), fetchJsonWithFallback(), formatOAuthError(), getErrorCode(), getErrorMessage(), isCertificateError(), refreshCodexAccessToken() (+1 more)
...
### Community 66 - "startCodexCliLogin"
Cohesion: 0.33
Nodes (7): extractCodexCliLoginHints(), isLikelyDeviceCode(), lastNonEmptyLine(), readProcessStream(), startCodexCliLogin(), stripAnsi(), updateCliSessionOutput()

### Community 67 - "quota.ts"
Cohesion: 0.33
Nodes (4): getUserStatus(), makeRequest(), ModelQuota, QuotaSnapshot
...
### Community 73 - "port-finder.ts"
Cohesion: 0.70
Nodes (4): execAsync, findLanguageServerForWorkspace(), getLanguageServerInfo(), LanguageServerInfo
...
## Knowledge Gaps
- **438 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+433 more)
...
- **Why does `AccountManager` connect `AccountManager` to `account-manager.ts`, `quota-aggregator.ts`, `auth/route.ts`, `antigravity/chat.ts`, `server.ts`, `ping.ts`, `routing/route.ts`, `router.ts`, `main.ts`, `quota-fetch.ts`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `ProviderAccount` connect `auth/types.ts` to `copilot/chat.ts`, `codex/chat.ts`, `grok/chat.ts`, `kiro/oauth.ts`, `quota-aggregator.ts`, `auth/route.ts`, `codex/oauth.ts`, `zed/chat.ts`, `store.ts`, `routing/route.ts`, `router.ts`, `authStore`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `UpstreamError` connect `UpstreamError` to `copilot/chat.ts`, `error.ts`, `codex/chat.ts`, `account-manager.ts`, `grok/chat.ts`, `antigravity/chat.ts`, `kiro/oauth.ts`, `quota-aggregator.ts`, `openai/handler.ts`, `server.ts`, `ping.ts`, `zed/chat.ts`, `router.ts`, `messages/handler.ts`, `quota-fetch.ts`?**
