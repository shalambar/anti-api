...
// OAuth 配置：凭据从环境变量读取（不再硬编码在源码中）
// ANTI_API_ANTIGRAVITY_CLIENT_ID / ANTI_API_ANTIGRAVITY_CLIENT_SECRET
export const OAUTH_CONFIG = {
    clientId: process.env.ANTI_API_ANTIGRAVITY_CLIENT_ID?.trim() || "",
    clientSecret: process.env.ANTI_API_ANTIGRAVITY_CLIENT_SECRET?.trim() || "",
    callbackPort: 51121,
